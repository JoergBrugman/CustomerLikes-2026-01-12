...
{
    var
        OnBeforeOnDeleteBookErr: Label 'You are not allowed to delete %1 %2 because it is liked by Customer(s)';
    ...
    local procedure "BSB Book List_OnBeforeHandleBookType"(Rec: Record "BSB Book"; var IsHandled: Boolean)
    var
